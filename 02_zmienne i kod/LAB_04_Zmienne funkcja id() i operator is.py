...
# czyli końcowa wartość.
# W drugim przykładzie a, b, c to wskaźnik do komórki pamięci, w której jest lista. 
# Lista jest wskaźnikiem do elementów tej listy. Kiedy dodajesz nowy element do listy, 
# nie modyfikujesz podstawowej komórki pamięci z listą, dlatego id się nie zmienił.
# -----------------------------
# Uwaga - w tym zadaniu można się spodziewać, że w różnych wersjach Pytona uzyskamy różne wyniki, 
# ale spróbujmy...
